function make(event) {
    let field = document.getElementById("put");
        ...
        if (event.code == "Enter" && field.value !== "") {
            ...
            let lowerLine = document.getElementById("lower");
            lowerLine.classList.add("lowerLine");
            count.hidden = false;
            all.hidden = false;
            active.hidden = false;
    ...
    function remove_deal(deal) {
        ...
        if (deals.length == 0 && checked_deals.length == 1) {
            ...
            lowerLine.classList.remove("lowerLine");
        }
    ...
    function check_noCheck(deal, checkbox) {
        ...
        if (active_button.classList.contains("button_active")) {
            deal.parentNode.classList.remove("lines");
    ...
    function All_Button() {
        ...
        for (let line of deals_completed) {
            line.parentNode.classList.add("lines");
        }
    ...
    function Active_Button() {
        ...
        for (let line of deals_completed) {
            line.parentNode.classList.remove("lines");
